            ...
            plants: [
                {
                    ...
                    description: "Requires little water, great for beginners.",
                    cost: "$25"
                },
                {
                    name: "Pothos",
                    image: "https://images.unsplash.com/photo-1584782109158-bfcf7006578d?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
                    description: "Tolerates low light and irregular watering.",
                    cost: "$18"
                },
                {
                    name: "Cast Iron Plant",
                    image: "https://images.unsplash.com/photo-1583909115078-15d5de68a953?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
                    description: "Survives neglect and low light conditions.",
                    cost: "$20"
                },
                {
                    name: "Snake Plant",
                    image: "https://cdn.pixabay.com/photo/2021/01/22/06/04/snake-plant-5939187_1280.jpg",
                    description: "Adaptable to various environments, needs little care.",
                    cost: "$15"
                },
                {
                    name: "Spider Plant",
                    image: "https://cdn.pixabay.com/photo/2018/07/11/06/47/chlorophytum-3530413_1280.jpg",
                    description: "Resilient plant that thrives with minimal attention.",
                    cost: "$12"
                },
                {
                    name: "Aloe Vera",
                    image: "https://cdn.pixabay.com/photo/2018/04/02/07/42/leaf-3283175_1280.jpg",
                    description: "Low-maintenance succulent with medicinal properties.",
                    cost: "$14"
                }
            ]
        }
    ...
    const handleAddToCart = (plant) => {
        setAddedToCart((prev) => {
            ...
            if (updatedCart[plant.name]) {
                ...
                updatedCart[plant.name] = { ...plant, quantity: 1 }; // Add new product to cart
            }
            return updatedCart;
        });
    };
